...
export default function Register() {
    ...
    async function onSubmit(e) {
        ...
        try {
            ...
            await axios.post('http://localhost:5000/signup', newPerson);
            await getLoggedIn();
            navigate('/');
...
return (
    <div className='blog__container'>
        ...
        <form onSubmit={onSubmit}>
               ...
               type='text' id='name' value={form.name} placeholder='Name'
               ...
               <br/>
                ...
                <button className='blog__btn' type='submit'> Sign Up </button>
        </form>
        </div>
        </div>
    </div>
